...
#
# Student: Edmond Febrinicko Armay
#
...
#<YOUR CODE HERE>
wget -q -P $FTTEMPDIR http://fortunecookieapi.herokuapp.com/v1/fortunes
# E3 (1 point)
...
#<YOUR CODE HERE>
cat $FTTEMPDIR/fortunes | json_pp > $FTTEMPDIR/fortunes_pp
# E5 (1 points)
...
#<YOUR CODE HERE>
NUMMSG=$(wc -l < $FTTEMPDIR/fortunes_messages)
# E9 (2 points)
